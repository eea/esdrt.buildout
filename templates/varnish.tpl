# Configuration based off the default output of plone.recipe.varnish:config
# Changed: backend and vcl_backend_response. The vcl_backend_response is
# the main reason for this template file as we want to make sure only static
